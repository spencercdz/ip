...
public class MainWindow {
    ...
    public void setJaku(Jaku jaku) {
        this.jaku = jaku;
        dialogContainer.getChildren().add(DialogBox.reply("Hello there! I'm Jaku. How can I help you today?"));
    }
    ...
    private void handleUserInput() {
        ...
        dialogContainer.getChildren().add(DialogBox.reply(jaku.getResponse(input)));
        userInput.clear();
